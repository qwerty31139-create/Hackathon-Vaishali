---
name: azure
description: Azure specialist, able to deploy OutSystems and other applications to Azure with best practices, infrastructure as code, and CI/CD pipelines. For OutSystems on-cloud deployments, integrates with OutSystems Cloud management.
